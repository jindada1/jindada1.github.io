    ...
    methods: {
        ...
        isValid(val) {
            ...
            if ((!fval && fval != 0) || fval < this.min || fval > this.max) {
                this.$message.error("Input should be in the range of " + this.fmtRange());
                return false;
            }
            if (this.tags.indexOf(fval) > -1) {
                this.$message.error(val + "already exists");
                return false;
            }
            return true
        },
        ...
        <div class="el-tools-item el-tools-item-col">
            <div v-if="value.length > 0">
                <el-row class="kris-table-row kris-table-header" >
                    ...
                    <el-col :span="7">Inside</el-col>
                    <el-col :span="10">Estimated pi</el-col>
                </el-row>
...
Vue.component('kris-user', {
    template: `
        <div>
            ...
            <div v-if="positive">diagnosed negative</div>
            <div v-else="positive">diagnosed positive</div>
        </div>
    `,
    props: {
        positive: {
